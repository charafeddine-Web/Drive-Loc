...
<body style="scroll-behavior: smooth;">
    ...
    <div id="ArticlesPage" class="max-w-7xl mx-auto p-6 bg-gray-50">
    <h3 class="text-3xl font-bold mb-8 text-gray-800 mt-20">My Articles</h3>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php foreach ($rs as $r): ?>
                ...
                switch ($status) {
                    ...
                    case 'accepted': $statusClass = 'bg-green-100 text-green-700'; break;
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="flex items-center p-4">
                        <img src="../assets/image/default-profile.png" alt="User Profile" class="w-10 h-10 rounded-full">
                        <div class="ml-3">
                            <p class="text-sm font-semibold text-gray-800">
                                <?php echo htmlspecialchars($_SESSION['fullname'] ?? 'Unknown Author'); ?>
                            </p>
                    ...
                    <?php if (!empty($r['imageArt'])): ?>
                        <img src="../assets/image/<?php echo htmlspecialchars($r['imageArt']); ?>" alt="Article Image" class="w-full h-64 object-cover">
                    <?php endif; ?>
                    ...
                    <div class="p-4">
                        ...
                        <?php if (!empty($r['video'])): ?>
                            <video controls class="w-full mt-4 rounded">
                                <source src="../assets/videos/<?php echo htmlspecialchars($r['video']); ?>" type="video/mp4">
                    ...
                    <!-- Actions -->
                    <div class="border-t flex justify-around p-4 text-gray-600">
